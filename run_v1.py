"""
Fraud Risk Scoring — V1: Classic PySpark (local Spark, data from Snowflake stage)

Compare with run_v2.py — only 2 secions differ:
  1. SparkSession creation  (local[*] vs snowpark_connect)
  2. Data loading           (stage via connector vs spark.read.table)
"""

VERSION = "V1"
VERSION_LABEL = "Classic PySpark (local)"
