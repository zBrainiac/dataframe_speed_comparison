"""
Fraud Risk Scoring — remote_SnowparkConnect_Optimized

Compare with remote_pySpark.py — only 2 sections differ:
  1. SparkSession creation  (local[*] vs snowpark_connect)
  2. Data loading           (stage via connector vs spark.read.table)
"""

VERSION = "remote_SnowparkConnect_Optimized"
